...
import ujjwalImage from '../data/leaders/1.jpeg';
import drSahooImage from '../data/leaders/Prof. Subhendu Kumar Sahoo.png';
import drPalImage from '../data/leaders/Dr. Subhradeep Pal.png';
...
const MessageCarousel = () => {
  ...
  <div key={index} style={messageCardStyle}>
    <img src={message.image} alt={message.author} style={leaderImageStyle} />
...
const MessageSection = () => {
  return (
    <div>
    <h1 className="bg-gradient-to-r from-red to-yellow text-transparent bg-clip-text text-[10vh] text-center">Messages from Leadership</h1>
